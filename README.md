...
4. Temporal Snapshot: The provided dataset lacks timestamps. Therefore, the Exponential Smoothing and Activity Decay logic was implemented as a modular function that expects to be fed historical states sequentially, assuming a decay rate (d) of 0.15 for periods of total inactivity.
